			...
			<div class="flex flex-col lg:flex-row justify-center max-[450px]:w-4/5 w-2/3">
				<div class="w-full lg:w-1/2 flex flex-col justify-center mt-5 lg:mt-0">
					<div class="flex w-full pb-1">
						...
						<input type="text" class="border-2 border-accent rounded-lg pt-0.2 pb-0.2 pl-1 ml-2" id="firstName" name="firstName" value={pets ? pets[currentPetIndex]?.firstName: ''} required/>
					</div>
					<div class="flex w-full pb-1">
					...
					<div class="flex w-full pb-1">
						...
						<input type="date" class="border-2 border-accent rounded-lg pt-0.2 pb-0.2 pl-1 ml-2" id="birthday_pet" name={pets ? pets[currentPetIndex]?.birthday: ''} required/>
					</div>
					<div class="flex w-full pb-1">
						<label class="max-[600px]:w-1/3 w-2/5 lg:w-1/3 text-right text-secondary font-semibold" for="species">Espèce :</label>
						<input type="text" class="border-2 border-accent rounded-lg pt-0.2 pb-0.2 pl-1 ml-2" id="species" name="specie" value={pets ? pets[currentPetIndex]?.species: ''} required/>					
					</div>
					<div class="flex w-full pb-1">
						<label class="max-[600px]:w-1/3 w-2/5 lg:w-1/3 text-right text-secondary font-semibold" for="breed">Race :</label>
						<input type="text" class="border-2 border-accent rounded-lg pt-0.2 pb-0.2 pl-1 ml-2" id="breed" name="breed" value={pets ? pets[currentPetIndex]?.breed: ''} required/>
					</div>
					<div class="flex w-full pb-1">
						<label class="max-[600px]:w-1/3 w-2/5 lg:w-1/3 text-right text-secondary font-semibold" for="weight">Poids :</label>
						<input type="text" class="border-2 border-accent rounded-lg pt-0.2 pb-0.2 pl-1 ml-2" id="weight" name="weight" value={pets ? pets[currentPetIndex]?.weight: ''} required/>
					</div>
					<div class="flex w-full pb-1">
