	...
	<div class="flex h-1/2">
		...
		{:else}
			<div class="w-1/3 flex justify-center items-center">
				<img src={userProfile.profilePicture} class="h-64 w-48 mt-6 rounded-3xl shadow-[-24px_-24px_#FFDB78]"
						 alt="Profil" />
			</div>
			<div class="w-1/3 flex flex-col justify-center">
				...
				<div class="flex w-full pb-1">
					...
					<p class="w-3/4 ml-2"
						 id="birthday">{formatter.format(new Date(Number(userProfile.birthday.split('/')[2]), Number(userProfile.birthday.split('/')[1]) - 1, Number(userProfile.birthday.split('/')[0])))}</p>
				</div>
				<div class="flex w-full pb-1">
			...
			<div class="w-1/3 flex flex-col justify-center items-center">
				...
				<button class="bg-white text-[#E91414] border border-secondary rounded-full w-3/5 mb-2">Supprimer le compte
				</button>
			</div>
		{/if}
	</div>
