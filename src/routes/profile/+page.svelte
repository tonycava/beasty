	...
	<div class="flex h-1/2">
		<div class="w-1/3 flex justify-center items-center">
			<img
				...
				class="h-64 w-48 mt-6 rounded-3xl shadow-[-24px_-24px_#FFDB78]"
				alt="Profil"
			/>
		</div>
		<div class="w-1/3 flex flex-col justify-center">
			<div class="flex w-full pb-1">
				<label class="w-1/3 text-right text-secondary font-semibold" for="first_name"
					>Prénom :</label
				>
				{#if userProfile === null}
					<p class="w-3/4 ml-2" id="first_name">...</p>
				{:else}
			...
			<div class="flex w-full pb-1">
				...
				<p class="w-3/4 ml-2" id="last_name">Doe</p>
			</div>
			<div class="flex w-full pb-1">
				<label class="w-1/3 text-right text-secondary font-semibold" for="age">Âge :</label>
				<p class="w-3/4 ml-2" id="age">24 ans</p>
			</div>
			<div class="flex w-full pb-1">
				<label class="w-1/3 text-right text-secondary font-semibold" for="birthday"
					>Anniversaire :</label
				>
				<p class="w-3/4 ml-2" id="birthday">5 mai</p>
			</div>
			<div class="flex w-full pb-1">
				<label class="w-1/3 text-right text-secondary font-semibold" for="email"
					>Adresse e-mail :</label
				>
				<p class="w-3/4 ml-2" id="email">jane.doe@gmail.com</p>
			</div>
			<div class="flex w-full pb-1">
			...
			<!-- <ul class="w-1/3 text-right text-secondary">
                <li class="">Prénom :</li>
                <li>Nom :</li>
                <li>Âge :</li>
                <li>Anniversaire :</li>
		...
		<div class="w-1/3 flex flex-col justify-center items-center">
			...
			<button class="bg-white text-[#E91414] border border-secondary rounded-full w-3/5 mb-2"
